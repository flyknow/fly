package cn.iocoder.fly.framework.tracer.config;

import cn.iocoder.fly.framework.common.enums.WebFilterOrderEnum;
import cn.iocoder.fly.framework.tracer.core.aop.BizTraceAspect;
import cn.iocoder.fly.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "fly.tracer", value = "enable", matchIfMissing = true)
public class FlyTracerAutoConfiguration {
