package cn.iocoder.fly.framework.operatelog.core.aop;
...
import cn.iocoder.fly.framework.operatelog.core.service.OperateLog;
import cn.iocoder.fly.framework.operatelog.core.service.OperateLogFrameworkService;
import cn.iocoder.fly.framework.web.core.util.WebFrameworkUtils;
...
import static cn.iocoder.fly.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static cn.iocoder.fly.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        cn.iocoder.fly.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                cn.iocoder.fly.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         cn.iocoder.fly.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           cn.iocoder.fly.framework.operatelog.core.annotations.OperateLog operateLog,
