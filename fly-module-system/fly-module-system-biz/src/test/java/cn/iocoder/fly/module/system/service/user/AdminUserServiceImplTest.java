package cn.iocoder.fly.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.iocoder.fly.framework.common.enums.CommonStatusEnum;
import cn.iocoder.fly.framework.common.exception.ServiceException;
import cn.iocoder.fly.framework.common.pojo.PageResult;
import cn.iocoder.fly.framework.common.util.collection.ArrayUtils;
import cn.iocoder.fly.framework.common.util.collection.CollectionUtils;
import cn.iocoder.fly.framework.test.core.ut.BaseDbUnitTest;
import cn.iocoder.fly.module.infra.api.file.FileApi;
import cn.iocoder.fly.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.iocoder.fly.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.iocoder.fly.module.system.controller.admin.user.vo.user.*;
import cn.iocoder.fly.module.system.dal.dataobject.dept.DeptDO;
import cn.iocoder.fly.module.system.dal.dataobject.dept.PostDO;
import cn.iocoder.fly.module.system.dal.dataobject.dept.UserPostDO;
...
import cn.iocoder.fly.module.system.dal.mysql.dept.UserPostMapper;
import cn.iocoder.fly.module.system.dal.mysql.user.AdminUserMapper;
import cn.iocoder.fly.module.system.enums.common.SexEnum;
...
import cn.iocoder.fly.module.system.service.tenant.TenantService;
...
import static cn.iocoder.fly.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.iocoder.fly.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.iocoder.fly.framework.common.util.object.ObjectUtils.cloneIgnoreId;
...
import static cn.iocoder.fly.framework.test.core.util.RandomUtils.*;
import static cn.iocoder.fly.module.system.enums.ErrorCodeConstants.*;
