package cn.iocoder.fly.module.infra.service.codegen.inner;
...
import cn.iocoder.fly.framework.common.exception.util.ServiceExceptionUtil;
...
import cn.iocoder.fly.framework.common.util.date.LocalDateTimeUtils;
import cn.iocoder.fly.framework.common.util.object.ObjectUtils;
import cn.iocoder.fly.framework.excel.core.annotations.DictFormat;
import cn.iocoder.fly.framework.excel.core.convert.DictConvert;
import cn.iocoder.fly.framework.excel.core.util.ExcelUtils;
import cn.iocoder.fly.framework.mybatis.core.dataobject.BaseDO;
...
import cn.iocoder.fly.framework.operatelog.core.enums.OperateTypeEnum;
import cn.iocoder.fly.module.infra.framework.codegen.config.CodegenProperties;
import cn.iocoder.fly.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import cn.iocoder.fly.module.infra.dal.dataobject.codegen.CodegenTableDO;
import cn.iocoder.fly.module.infra.enums.codegen.CodegenFrontTypeEnum;
import cn.iocoder.fly.module.infra.enums.codegen.CodegenSceneEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "fly-module-${table.moduleName}/" + // 顶级模块
                "fly-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "fly-module-${table.moduleName}/" + // 顶级模块
                "fly-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "fly-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "fly-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
