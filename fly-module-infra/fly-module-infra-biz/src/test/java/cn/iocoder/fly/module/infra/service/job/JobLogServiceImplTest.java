...
import cn.iocoder.fly.module.infra.dal.mysql.job.JobLogMapper;
import cn.iocoder.fly.module.infra.enums.job.JobLogStatusEnum;
...
public class JobLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateJobLog() {
        ...
        Assertions.assertEquals(JobLogStatusEnum.RUNNING.getStatus(), job.getStatus());
    }
